...
public class EntityListArray implements EntityListInterface, EntityEventListener {
    ...
    /**
     * The entities in the array. Make it protected to allow sub-classes access but none else.
     */
    ...
    @Override
    public void clear() {
//    public void clear(int maxNumEntities, int maxNumRemoveEntities) {
        this.numEntities = 0;
        this.numRemoveEntities = 0;
        this.entities = new Entity[MAX_SIZE];
        this.removeEntities = new Entity[MAX_SIZE];
    ...
    public void increaseSpeed(int percentIncr) {
        double getHorizontalMovement = 0;
        ...
        for (int i = 0; i < this.numEntities; i++) {
            entities[i].setHorizontalMovement(entities[i].getHorizontalMovement()
                * percentIncr / 100 + entities[i].getHorizontalMovement());
            entities[i].setVerticalMovement(entities[i].getVerticalMovement()
                * percentIncr / 100 + entities[i].getVerticalMovement());
